...
# What do you see?
ggplot(diamonds.sample, aes(x=carat, y=price) )
...
ggplot(diamonds.sample, aes(x=carat, y=price, color = clarity) ) +
geom_point()
...
ggplot(diamonds.sample, aes(x=carat, y=price, color=blue) ) +
geom_point()
